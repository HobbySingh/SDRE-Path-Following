...
%% FOR MULTIPLE WAYPOINTS - COPY PASTE CODE FOR NEW WAYPOINTS

w1_x = 0; w1_y = 0; w1_z = 0;
% w2_x = 600; w2_y = 0; w2_z = 600;
w2_x = 600; w2_y = 0; w2_z = 600;
...
% odeFuncSLine
[t,y] = ode45(@(t,y) odeFuncSLine3d_integral(t,y,w1_x,w1_y,w1_z,w2_x,w2_y,600,0.3), tspan, y0);
[t1,y1] = ode45(@(t1,y1) odeFuncSLine3d_integral(t1,y1,w1_x,w1_y,w1_z,w2_x,w2_y,30,0.3), tspan, y0);
...
% [t,y] = ode45(@(t,y) odeFuncSLine3d(t,y,w1_x,w1_y,w1_z,w2_x,w2_y,w2_z,0), tspan, y0);
% hold on
% plot3(y(:,1),y(:,2),y(:,5),'-m','LineWidth',lw);
% grid on
