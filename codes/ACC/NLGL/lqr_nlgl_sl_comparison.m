...
while ( dist_wp >= delta && wp <= last_wp)
    ...
    options = odeset('OutputFcn',@(t,y,flag) sl_op_fx_lqr_integral_state(t,y,flag,w1_x,w1_y,w1_z,w2_x,w2_y,w2_z,w_spd_ratio,curr_u_xy,curr_u_z,curr_d_xy,curr_d_z,curr_si));
