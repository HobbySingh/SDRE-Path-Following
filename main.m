...
% waypoints = [[0, 0, 0]; [600, 0, 0]; [1200, 300, 0];[900,900,0]; [300, 1200,0]; [0,600,0]; [0, 0, 0]; [0 0 0]];
...
while ( dist_wp > delta && wp <= last_wp)
    ...
    [t1,y1] = ode45(@(t1,y1) odeFuncSLine3d(t1,y1,w1_x,w1_y,w1_z,w2_x,w2_y,w2_z,w_spd_ratio), tspan, y0);
